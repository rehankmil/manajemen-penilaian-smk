                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text-center mb-4">
                                <img src="{{ asset('../' . $guru->avatar) }}" alt="{{ $guru->nama }}" class="img-thumbnail rounded-circle" width="150">
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Tanggal Lahir</th>
                                            <td>{{ \Carbon\Carbon::parse($guru->tgl_lahir)->format('d F Y') }}</td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                <a href="{{ route('guru.edit', $guru->id) }}" class="btn btn-warning mr-2">
