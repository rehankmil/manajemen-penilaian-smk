                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('murid.update', $murid->id) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="nis" type="text" class="form-control @error('nis') is-invalid @enderror" name="nis" value="{{ old('nis', $murid->nis) }}" required autofocus>
                                    @error('nis')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama', $murid->nama) }}" required>
                                    @error('nama')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="kelas_id" class="form-control @error('kelas_id') is-invalid @enderror" name="kelas_id" required>
                                        ...
                                        @foreach($kelas as $kela)
                                            <option value="{{ $kela->id }}" {{ old('kelas_id', $murid->kelas_id) == $kela->id ? 'selected' : '' }}>
                                                {{ $kela->kode }}
                                            </option>
                                        @endforeach
                                    </select>
