                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="mapel_id" id="mapel_id" class="form-control @error('mapel_id') is-invalid @enderror" required>
                                                ...
                                                <option value="{{ $mapel->id }}" {{ (old('mapel_id') ?? $nilai->mapel_id) == $mapel->id ? 'selected' : '' }}>
                                                    {{ $mapel->nama }}
                                                </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kelas_id" id="kelas_id" class="form-control @error('kelas_id') is-invalid @enderror" required>
                                                ...
                                                @foreach($kelasList as $kelas)
                                                    <option value="{{ $kelas->id }}" {{ (old('kelas_id') ?? $nilai->murid->kelas->id) == $kelas->id ? 'selected' : '' }}>
                                                        {{ $kelas->kode }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="guru_id" id="guru_id" class="form-control @error('guru_id') is-invalid @enderror" required>
                                                ...
                                                @if(old('mapel_id') && old('guru_id'))
                                                    ...
                                                    @endforeach
                                                @else
                                                    @foreach($guruList->where('mapel_id', $nilai->mapel_id) as $guru)
                                                        <option value="{{ $guru->id }}" {{ ($nilai->guru_id ?? old('guru_id')) == $guru->id ? 'selected' : '' }}>
                                                            {{ $guru->nama }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="murid_id" id="murid_id" class="form-control @error('murid_id') is-invalid @enderror" required>
                                                ...
                                                @if(old('kelas_id') && old('murid_id'))
                                                    ...
                                                    @endforeach
                                                @else
                                                    @foreach($muridList->where('kelas_id', $nilai->murid->kelas->id) as $murid)
                                                        <option value="{{ $murid->id }}" {{ ($nilai->murid_id ?? old('murid_id')) == $murid->id ? 'selected' : '' }}>
                                                            {{ $murid->nama }}
                                                        </option>
                                                    @endforeach
                                                @endif
                        ...
                        <div class="card-body">
                            <form action="{{ route('nilai.update', $nilai->id) }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="murid_id" id="murid_id" class="form-control @error('murid_id') is-invalid @enderror" required>
                                                ...
                                                @foreach($muridList as $murid)
                                                    <option value="{{ $murid->id }}" {{ (old('murid_id') ?? $nilai->murid_id) == $murid->id ? 'selected' : '' }}>
                                                        {{ $murid->nama }} ({{ $murid->kelas->kode ?? 'Belum ada kelas' }})
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('murid_id')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="guru_id" id="guru_id" class="form-control @error('guru_id') is-invalid @enderror" required>
                                                ...
                                                @foreach($guruList as $guru)
                                                    <option value="{{ $guru->id }}" {{ (old('guru_id') ?? $nilai->guru_id) == $guru->id ? 'selected' : '' }}>
                                                        {{ $guru->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Predikat Saat Ini</label>
                                            <input type="text" class="form-control" value="{{ $nilai->predikat }}" disabled>
                                            <small class="form-text text-muted">Predikat akan dihitung otomatis berdasarkan nilai</small>
                                        </div>
                                    </div>
                                </div>
