        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{ route('guru.profil') }}" class="btn btn-info btn-sm">Kembali</a>
                </div>
                <div class="card">
                    <div class="card-body">
                        @if (session('error'))
                        ...
                        <form method="POST" action="{{ route('guru.profil.update') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <h4 class="form-control">{{ $guru->nip }}</p>
                            </div>
                            <div class="mb-3">
                                <label for="nama" class="form-label">Nama</label>
                                <h4 class="form-control">{{ $guru->nama }}</p>
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">Email</span></label>
                                <h4 class="form-control">{{ $guru->email }}</p>
                            </div>
                            <div class="mb-3">
